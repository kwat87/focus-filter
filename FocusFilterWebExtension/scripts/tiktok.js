...
(() => {
  ...
  function showBlockedPage() {
    ...
    document.body.innerHTML =
      ...
      '<button onclick="window.location.replace(\'https://www.google.com\')" style="color:#25f4ee;background:none;border:none;cursor:pointer;font-size:16px;text-decoration:underline">Leave this page</button></div></div>';
  }
